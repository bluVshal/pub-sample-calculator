...
const CurrencyExchange = () => {
    return (
        <div>
            <form method="GET" action="https://coinmill.com/currency" onsubmit="if (this.currencyamount.value==''){alert('Please enter an amount');return false;}if (this.currencyfrom.selectedIndex==0){alert('Please choose a currency.');return false;}return true;">
